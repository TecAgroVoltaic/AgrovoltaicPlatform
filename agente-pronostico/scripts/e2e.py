...
La clave se toma de FORECAST_API_KEY o PRONOSTICO_API_KEY (no se imprime nunca).
...
KEY = os.environ.get("FORECAST_API_KEY") or os.environ.get("PRONOSTICO_API_KEY") or ""
