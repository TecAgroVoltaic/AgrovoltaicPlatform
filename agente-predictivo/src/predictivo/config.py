...
# Raiz del proyecto = agente-predictivo/ (dos niveles arriba de este archivo:
#   .../agente-predictivo/src/predictivo/config.py  -> parents[2] = agente-predictivo/)
...
# de fuente (agente-predictivo/src/predictivo/). Instalado con pip el paquete vive
