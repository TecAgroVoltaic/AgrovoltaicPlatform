...
% JetBrains Mono es una fuente DEL SISTEMA y no esta en todas las maquinas
% (en macOS, por ejemplo, no viene). Se degrada con gracia en vez de romper
% la compilacion: Menlo, y si tampoco esta, la Latin Modern de texmf.
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\color{humo}AgroVoltaic $\cdot$ Arquitectura del sistema}
