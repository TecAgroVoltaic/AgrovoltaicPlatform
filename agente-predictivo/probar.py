...
from predictivo.tools.forecast_tool import run_forecast  # noqa: E402
...
def demo_agente() -> None:
    ...
    if not os.environ.get("ANTHROPIC_API_KEY"):
        ...
        return
    from predictivo.agent.agent import ForecastAgent  # import diferido
...
def main() -> int:
    try:
        ...
        print("     AGRODASH_PASSWORD=... python -m predictivo.data")
        return 1
    print("\n" + LINEA)
