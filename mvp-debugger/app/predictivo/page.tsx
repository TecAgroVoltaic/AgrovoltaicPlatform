...
export default function PronosticoPage() {
  return (
    <div>
      <h1>🌦️ Agente Predictivo · debugger</h1>
      <Health servicio="predictivo" nombre="Agente Predictivo (:8000)" />
