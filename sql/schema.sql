...
SELECT
    ...
    corriente_aac,
    CASE WHEN (potencia_pv1_w > 5000.0 OR potencia_pv2_w > 5000.0 OR voltaje_pv1_v > 600.0 OR voltaje_pv2_v > 600.0 OR corriente_pv1_a > 20.0 OR corriente_pv2_a > 20.0 OR potencia_total_wac > 5000.0 OR temperatura_inversor_c > 100.0 OR potencia_pv1_w < 0.0 OR potencia_pv2_w < 0.0 OR voltaje_pv1_v < 0.0 OR voltaje_pv2_v < 0.0) IS TRUE THEN NULL ELSE energia_hoy_wh END AS energia_hoy_wh,
    CASE WHEN (potencia_pv1_w > 5000.0 OR potencia_pv2_w > 5000.0 OR voltaje_pv1_v > 600.0 OR voltaje_pv2_v > 600.0 OR corriente_pv1_a > 20.0 OR corriente_pv2_a > 20.0 OR potencia_total_wac > 5000.0 OR temperatura_inversor_c > 100.0 OR potencia_pv1_w < 0.0 OR potencia_pv2_w < 0.0 OR voltaje_pv1_v < 0.0 OR voltaje_pv2_v < 0.0) IS TRUE THEN NULL ELSE energia_total_wh END AS energia_total_wh,
    CASE WHEN (potencia_pv1_w > 5000.0 OR potencia_pv2_w > 5000.0 OR voltaje_pv1_v > 600.0 OR voltaje_pv2_v > 600.0 OR corriente_pv1_a > 20.0 OR corriente_pv2_a > 20.0 OR potencia_total_wac > 5000.0 OR temperatura_inversor_c > 100.0 OR potencia_pv1_w < 0.0 OR potencia_pv2_w < 0.0 OR voltaje_pv1_v < 0.0 OR voltaje_pv2_v < 0.0) IS TRUE THEN NULL ELSE energia_pv1_wh END AS energia_pv1_wh,
    CASE WHEN (potencia_pv1_w > 5000.0 OR potencia_pv2_w > 5000.0 OR voltaje_pv1_v > 600.0 OR voltaje_pv2_v > 600.0 OR corriente_pv1_a > 20.0 OR corriente_pv2_a > 20.0 OR potencia_total_wac > 5000.0 OR temperatura_inversor_c > 100.0 OR potencia_pv1_w < 0.0 OR potencia_pv2_w < 0.0 OR voltaje_pv1_v < 0.0 OR voltaje_pv2_v < 0.0) IS TRUE THEN NULL ELSE energia_pv2_wh END AS energia_pv2_wh,
