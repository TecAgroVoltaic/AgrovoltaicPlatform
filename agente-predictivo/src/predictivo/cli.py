...
Punto de entrada de linea de comandos.
    ...
    python -m predictivo.cli "¿cuanta irradiancia va a haber en 2 horas?"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not pregunta:
        print('Uso: python -m predictivo.cli "¿cuanta irradiancia va a haber en 2 horas?"')
        return 2
    ...
    from predictivo import config  # noqa: F401
