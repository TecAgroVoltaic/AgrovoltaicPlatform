...
from predictivo import config, costos
from predictivo.agent.prompts import (PROMPT_MEDICION_OCULTA, PROMPT_MEDICION_VISIBLE,
                                      SYSTEM_PROMPT)
from predictivo.tools.backtest_tool import SCHEMA as BACKTEST_SCHEMA, run as run_backtest
from predictivo.tools.diagnostico_tool import (
    SCHEMA_CONDICIONES, SCHEMA_HISTORICO, run_condiciones, run_historico,
)
from predictivo.tools.predecir_tool import SCHEMA as PREDECIR_SCHEMA, run as run_predecir
from predictivo.tools.riesgo_tool import SCHEMA as RIESGO_SCHEMA, run as run_riesgo
...
# Juegos de herramientas por MODO.
#
# Los dos modos se distinguen por UNA sola cosa, y de ahi salen sus nombres:
