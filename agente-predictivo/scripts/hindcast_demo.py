...
docs/predictivo/img/. Requiere AGRODASH_PASSWORD solo si el cache no existe aun.
"""
...
from predictivo import data, physics
from predictivo.forecasters import naive_persistence, smart_persistence
...
IMG = Path(__file__).resolve().parents[1] / "docs" / "predictivo" / "img"
