...
from predictivo import anomalias as anomalias_mod
from predictivo import audit
from predictivo import claves
from predictivo import backtest as backtest_mod
from predictivo import data as data_mod
from predictivo import limites
from predictivo import observabilidad
from predictivo import salud as salud_mod
from predictivo import uso as uso_mod
...
app = FastAPI(
    title="Agente Predictivo (irradiancia + humedad de suelo)",
...
def arquitectura() -> dict:
    ...
    from predictivo import arquitectura as arquitectura_mod
...
def _agente():
    global _AGENTE
    if _AGENTE is None:
        from predictivo.agent.agent import ForecastAgent
