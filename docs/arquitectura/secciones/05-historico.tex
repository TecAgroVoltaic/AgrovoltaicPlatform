...
\cd{calidad\_periodo} & Veredicto de calidad: dias utilizables, degradados y sin datos. \\
\cd{hallazgos\_calidad} & Que esta mal y donde, por tipo de problema y severidad. \\
\cd{cielo\_periodo} & Como estuvo el cielo: kt medio, variabilidad y reparto de dias. \\
\bottomrule
\end{tabular}
\end{center}

Las tres ultimas llegaron de fusionar lo que iba a ser un agente aparte, el
comparador, cuando quedo claro que no era otro agente sino tres herramientas mas
del mismo: responden sobre el mismo historico y contra la misma base.
